...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initresidual(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initresidual(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_residual(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_residual(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_residual(void)", 0);
