...
static PyObject *__pyx_pf_5c_fun_main(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_arr_view_1, __Pyx_memviewslice __pyx_v_arr_view_2); /* proto */
...
static PyObject *__pyx_pw_5c_fun_1main(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_memviewslice __pyx_v_arr_view_2 = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  ...
  __Pyx_RefNannySetupContext("main (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_arr_view_1)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_arr_view_2)) != 0)) kw_args--;
        else {
    ...
    __pyx_v_arr_view_1 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_arr_view_1.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_arr_view_2 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_arr_view_2.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
  }
...
static PyObject *__pyx_pf_5c_fun_main(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_arr_view_1, __Pyx_memviewslice __pyx_v_arr_view_2) {
 ...
 * 
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(((PyObject *)__pyx_v_out_arr), PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 11, __pyx_L1_error)
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_out_view.data + __pyx_t_12 * __pyx_v_out_view.strides[0]) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_arr_view_1.data + __pyx_t_10 * __pyx_v_arr_view_1.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_arr_view_2.data + __pyx_t_11 * __pyx_v_arr_view_2.strides[0]) ))));
  }
 ...
 */
  ...
  __pyx_r = ((PyObject *)__pyx_v_out_arr);
  goto __pyx_L0;
 ...
 *     cdef object[double, ndim = 1] out_arr = np.zeros(arr_view_1.shape[0], dtype = np.float64)
 */
  __pyx_tuple__31 = PyTuple_Pack(5, __pyx_n_s_arr_view_1, __pyx_n_s_arr_view_2, __pyx_n_s_out_arr, __pyx_n_s_out_view, __pyx_n_s_i); if (unlikely(!__pyx_tuple__31)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__31);
  __Pyx_GIVEREF(__pyx_tuple__31);
  __pyx_codeobj__32 = (PyObject*)__Pyx_PyCode_New(2, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__31, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_c_fun_pyx, __pyx_n_s_main_2, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__32)) __PYX_ERR(0, 8, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initc_fun(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initc_fun(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_c_fun(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_c_fun(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_c_fun(void)", 0);
